...
const sentimentAnalysisPrompt = ai.definePrompt({
  ...
  prompt: `
        ...
        You MUST search the web to find the top 5 most recent news articles for the company identified by the user as "{{ticker}}".
...
export const sentimentAnalysisFlow = ai.defineFlow(
  ...
  async ({ ticker }): Promise<TickerAnalysisOutput> => {
